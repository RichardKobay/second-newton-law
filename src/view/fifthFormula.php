...
<body>
    <div id="app" class="app">
        <div id="formContainer" class="form-container">
            <form action="/src/php/calcFifthFormula.php" method="get" id="form" class="form">
                ...
                <div class="inputs-container">
                    ...
                    <label for="aceleration">Velocidad final</label>
                    <input type="number" name="vf" id="time_input" placeholder="s">
    ...
    <script src="/src/js/changingPlaceHoldersFifthFormula.js"></script>
</body>
